...
class ExecuteModelState(NamedTuple):
    ...
    logits: torch.Tensor
    dynamic_temps: torch.Tensor | None
    dynamic_top_ps: torch.Tensor | None
...
class GPUModelRunner(
    ...
    def _compute_logits_with_dynamic_sampling(
        ...
        if is_autodeco and dynamic_sampling_indices:
            ...
            compute_results = (
                self.model.compute_logits(sample_hidden_states, None)
                if is_autodeco else
        ...
        return logits, dynamic_temps, dynamic_top_ps, ats_temperature_scales
    ...
    def execute_model(
        ...
        with record_function_or_nullcontext("gpu_model_runner: postprocess"):
            ...
            if not self.broadcast_pp_output:
                ...
                ) = self._compute_logits_with_dynamic_sampling(
                    sample_hidden_states, dynamic_sampling_configs)
            else:
                # Rare case.
                ...
                dynamic_temps = broadcasted.get("temps")
                dynamic_top_ps = broadcasted.get("top_ps")
                ats_temperature_scales = broadcasted.get(
                    "ats_temperature_scales")
